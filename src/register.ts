...
const pwd2 = document.getElementById("confirm-password") as HTMLInputElement;
...
class Register {
    ...
    showPopover(target:string, msg:string) {
        const targetPopover = document.getElementById(target) as HTMLDivElement;
        targetPopover.innerHTML = msg;
        targetPopover.showPopover();
    }

    hidePopover(target:string) {
        const targetPopover = document.getElementById(target) as HTMLDivElement;
